  ...
  return (
    <LayoutInfo>
      <>
        ...
        <p>
          Thanks to the following people who have discovered and responsibly disclosed security
          holes in Hacker News:
        </p>

        <p>
          <b>
            2023-01-02: <a href="https://carter.sande.duodecima.technology/">Carter Sande</a>,
            <a href="http://www.slatersf.com">Mark Slater</a>,
            <a href="https://james.darpinian.com/">James Darpinian</a>
          </b>
        </p>
        <ul>
        ...
        <p>
          <b>2022-09-04: Dimitris Triantafyllidis</b>
        </p>
        <ul>
        ...
        <p>
          <b>
            2021-06-07:{' '}
            <a href="https://news.ycombinator.com/user?id=atamyrat">Atamyrat Hezretgulyyev</a>
          </b>
        </p>
        <ul>
        ...
        <ul>
          <li>Set the SameSite cookie attribute for better CSRF protection.</li>
        </ul>
        <p></p>
        ...
        <ul>
          <li>
            Information leaked during /r processing allowed an attacker to discover valid profile
            edit links and the user for which they were valid.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            mistakenly published to the Firebase API. More{' '}
        ...
        <ul>
          <li>
            Some pages displaying forms were vulnerable to reflected XSS when provided malformed
        ...
        <ul>
          <li>Someone creating a new account could sometimes take an existing username.</li>
        </ul>
        <p></p>

        <p>
          <b>
            2009-06-03: <a href="https://www.dfranke.us/">Daniel Fox Franke</a>
          </b>
        </p>
        <ul>
          <li>
            The state of the PRNG used to generate cookies could be determined from observed
            outputs. This allowed an attacker to fairly easily determine valid user cookies and
            compromise accounts. More <a href="https://news.ycombinator.com/item?id=639976">here</a>
            .
          </li>
        </ul>
        <p></p>
        ...
        <p>
          ...
          If you reported a vulnerability to us and don't see your name, please shoot us an email
          and we'll happily add you. We crawled through tons of emails trying to find all reports
          but inevitably missed some.
        </p>
      </>
    </LayoutInfo>
  );
